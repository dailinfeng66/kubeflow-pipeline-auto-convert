...
def search_py_file(path):
    ...
    for file in file_list:
        ...
        elif file.endswith(".py") and not file.endswith("_res.py") and (not file.startswith("plot") and file.endswith(".py")) :
            # 如果是py文件就对其进行处理
...
if __name__ == '__main__':
    ...
    # 扫描每一个class,获取每一个class方法所使用的方法，并将这些方法添加到调用的方法中
    # 暂时不这样做，直接将方法
    ...
    # 遍历所有的方法，这些方法中调用了那些方法，就将那些方法添加到当前方法中   没有递归 只引入了一层
